 ...
 * @author Dvr
 */
public class CheckFechamento implements Runnable {
                            ...
                            for (Horario horario : listHorario) {
                                ...
                                if (horario.getDiaSemana().equals(diaSemana)) {
                                    ...
                                    if (horaAbre > 0 || horaFecha > 0) {
                                        ...
                                        long minFechamento = new DateTime(horario.getHoraFecha()).getMinuteOfDay() + 30; //folga de meia hora
                                        long minSistema = new DateTime().getMinuteOfDay();

                                        if (!dataRecebimento.equals(dataSistema)) {
                                            if (minSistema > minFechamento) {
                                                ...
                                                warningAlarme.setIdprotocolo(jpaProtocol.findProtocolo(237));
